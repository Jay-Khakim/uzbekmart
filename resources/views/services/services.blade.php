                        ...
                        <div class="shop-product-wrap grid listview row">
                            ...
                            {{-- <div class="col-lg-4">
                                <div class="slide-item">
                                    <div class="single_product">
                                        <div class="product-img">
                                            <a href="service/s2.html">
                                                <img class="primary-img" src="assets/images/service/2.jpg" alt="Hiraola's Product Image">
                                            </a>
                                            <!-- <span class="sticker-2">New</span> -->
                                        </div>
                                        <div class="hiraola-product_content">
                                            <div class="product-desc_info">
                                                <h6 align="center"><a class="product-name" href="service/s2.html">JSC «Yo’lRefTrans»</a></h6>
                                                <div class="additional-add_action">
                                                    <ul>
                                                        <li class="quick-view-btn" data-toggle="modal" data-target="#exampleModalCenter"><a href="javascript:void(0)" data-toggle="tooltip" data-placement="top" title="Quick View"><i
                                                            class="ion-eye"></i></a></li>
                                ...
                                <div class="list-slide_item">
                                    <div class="single_product">
                                        ...
                                        <div class="hiraola-product_content">
                                            <div class="product-desc_info">
                                                <h6><a class="product-name" href="service/s2.html">JSC «Yo’lRefTrans»</a></h6>
                                                <div class="rating-box">
                                                    <ul>
                                                        <li><i class="fa fa-star-of-david"></i></li>
                                                        <li><i class="fa fa-star-of-david"></i></li>
                                                ...
                                                <div class="product-short_desc">
                                                    <p>Sizni O'rta Osiyo mintaqasidagi yagona temir yo'l kompaniyasi - "O'zbekiston temir yo'llari" ga tegishli bo'lgan tez buziladigan yuklarni izotermik harakatlantiruvchi transportda tashish bo'yicha "Yo'lRefTrans" OAJ hamkorlik qilishga taklif qiladi.</p>
                                                </div>
                                            </div>
                                            <div class="add-actions">
                                                <ul>
                                                    <li><a class="hiraola-add_cart" href="service/s2.html" data-toggle="tooltip" data-placement="top" title="Batafsil Information">Batafsil</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="col-lg-4">
                                <div class="slide-item">
                                    <div class="single_product">
                                        <div class="product-img">
                                            <a href="service/s3.html">
                                                <img class="primary-img" src="assets/images/service/3.jpg" alt="Hiraola's Product Image">
                                            </a>
                                            <span class="sticker-2">New</span>
                                        </div>
                                        <div class="hiraola-product_content">
                                            <div class="product-desc_info">
                                                <h6 align="center"><a class="product-name" href="service/s3.html"> Customs Clearance (declaration)</a></h6>
                                                <div class="additional-add_action">
                                                    <ul>
                                                        <li class="quick-view-btn" data-toggle="modal" data-target="#exampleModalCenter"><a href="javascript:void(0)" data-toggle="tooltip" data-placement="top" title="Quick View"><i
                                                            class="ion-eye"></i></a></li>
                                ...
                                <div class="list-slide_item">
                                    <div class="single_product">
                                        ...
                                        <div class="hiraola-product_content">
                                            <div class="product-desc_info">
                                                <h6><a class="product-name" href="service/s3.html">Customs Clearance (declaration)</a></h6>
                                                <div class="rating-box">
                                                    <ul>
                                                        <li><i class="fa fa-star-of-david"></i></li>
                                                        <li><i class="fa fa-star-of-david"></i></li>
                                                ...
                                                <div class="product-short_desc">
                                                    <p> Bojxona rasmiylashtiruvi xizmati (deklaratsiya)</p>
                                                </div>
                                            </div>
                                            <div class="add-actions">
                                                <ul>
                                                    <li><a class="hiraola-add_cart" href="service/s3.html" data-toggle="tooltip" data-placement="top" title="Batafsil Information">Batafsil</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
