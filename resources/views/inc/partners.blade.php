                    ...
                    <div class="col-lg-12">
                        <div class="product-tab">
                            <div class="hiraola-tab_title">
                                <h4>@lang("Embassies of Uzbekistan in abroad")</h4>
                            </div>
                        </div>
                        <div class="col-lg-12">
                        <div class="hiraola-product_slider">
                                ...
                                <div class="single_product" >
                                    <div class="product-img">
                                        <a href="javascript:void(0)">
                                            <img class="primary-img" src="/assets/images/flag/1.jpg" alt="Hiraola's Product Image">
                                        </a>
                                    ...
                                    <div class="hiraola-product_content">
                                        <div class="product-desc_info" >
                                            <h6 align="center">
                                                ...
                                                @lang("Embassy of Uzbekistan in India")</a>
                                            </h6>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="slide-item" >
                                <div class="single_product" >
                                    <div class="product-img">
                                        <a href="javascript:void(0)">
                                            <img class="primary-img" src="/assets/images/flag/2.jpg" alt="Hiraola's Product Image">
                                        </a>
                                    ...
                                    <div class="hiraola-product_content">
                                        <div class="product-desc_info" >
                                            <h6 align="center">
                                                <a class="product-name" href="javascript:void(0)">@lang("Embassy of Uzbekistan in Azerbaijan")</a>
                                            </h6>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="slide-item" >
                                <div class="single_product" >
                                    <div class="product-img">
                                        <a href="javascript:void(0)">
                                            <img class="primary-img" src="/assets/images/flag/3.jpg" alt="Hiraola's Product Image">
                                        </a>
                                    ...
                                    <div class="hiraola-product_content">
                                        <div class="product-desc_info" >
                                            <h6 align="center">
                                                <a class="product-name" href="javascript:void(0)">@lang("Embassy of Uzbekistan in Kazakhstan")</a>
                                            </h6>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="slide-item"  >
                                <div class="single_product" >
                                    <div class="product-img">
                                        <a href="javascript:void(0)">
                                            <img class="primary-img" src="/assets/images/flag/4.jpg" alt="Hiraola's Product Image">
                                        </a>
                                    ...
                                    <div class="hiraola-product_content">
                                        <div class="product-desc_info" >
                                            <h6 align="center">
                                                <a class="product-name" href="javascript:void(0)">@lang("Embassy of Uzbekistan in Pakistan")</a>
                                            </h6>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="slide-item" >
                                <div class="single_product" >
                                    <div class="product-img">
                                        <a href="javascript:void(0)">
                                            <img class="primary-img" src="/assets/images/flag/5.jpg" alt="Hiraola's Product Image">
                                        </a>
                                    ...
                                    <div class="hiraola-product_content">
                                        <div class="product-desc_info pt-2">
                                            <h6 align="center">
                                                <a class="product-name" href="javascript:void(0)">@lang("Embassy of Uzbekistan in Russia")</a>
                                            </h6>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="slide-item" >
                                <div class="single_product" >
                                    <div class="product-img">
                                        <a href="javascript:void(0)">
                                            <img class="primary-img" src="/assets/images/flag/6.jpg" alt="Hiraola's Product Image">
                                        </a>
                                        
                                    </div>
                                    <div class="hiraola-product_content">
                                        <div class="product-desc_info pt-1">
                                            <h6 align="center"><a class="product-name" href="javascript:void(0)">@lang("Embassy of Uzbekistan in the United States")</a></h6>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="slide-item" >
                                <div class="single_product" >
                                    <div class="product-img">
                                        <a href="javascript:void(0)">
                                            <img class="primary-img" src="/assets/images/flag/7.jpg" alt="Hiraola's Product Image">
                                        </a>
                                    ...
                                    <div class="hiraola-product_content">
                                        <div class="product-desc_info pt-1">
                                            <h6 align="center">
                                                <a class="product-name" href="javascript:void(0)">@lang("Embassy of Uzbekistan in Turkey")</a>
                                            </h6>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="slide-item" >
                                <div class="single_product" >
                                    <div class="product-img">
                                        <a href="javascript:void(0)">
                                            <img class="primary-img" src="/assets/images/flag/8.jpg" alt="Hiraola's Product Image">
                                        </a>
                                    ...
                                    <div class="hiraola-product_content">
                                        <div class="product-desc_info pt-1">
                                            <h6 align="center">
                                                <a class="product-name" href="javascript:void(0)">@lang("Embassy of Uzbekistan in Ukraine")</a>
                                            </h6>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="hiraola-product_slider">
                            ...
                            <div class="slide-item" >
                                <div class="single_product" >
                                    ...
                                    <div class="hiraola-product_content">
                                        <div class="product-desc_info" style="padding-bottom: 28px;">
                                            <h6 align="center"><a class="product-name" href="https://www.asianafrican.org/">@lang("Asian-African Chamber of Commerce & Industry (AACCI)")</a></h6>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="slide-item" >
                                <div class="single_product" >
                                    ...
                                    <div class="hiraola-product_content">
                                        <div class="product-desc_info" style="padding-bottom: 40px;">
                                            <h6 align="center"><a class="product-name" href="https://rcci.org.pk/">@lang("Rawalpindi Chamber of Commerce and Industry (RCCI)")</a></h6>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="single_product" >
                                    ...
                                    <div class="hiraola-product_content">
                                        <div class="product-desc_info" style="padding-bottom: 10px;">
                                            <h6 align="center"><a class="product-name" href="http://www.ascame.org/">@lang("The Association of the Mediterranean Chambers of Commerce and Industry (ASCAME)")</a></h6>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="slide-item"  >
                                <div class="single_product" >
                                    ...
                                    <div class="hiraola-product_content">
                                        <div class="product-desc_info" style="padding-bottom: 10px;">
                                            <h6 align="center"><a class="product-name" href="https://www.micci.com/Index.aspx">@lang("Malaysian International Chamber of Commerce & Industry(MICCI)")</a></h6>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="single_product" >
                                    ...
                                    <div class="hiraola-product_content">
                                        <div class="product-desc_info pt-2" style="padding-bottom: 15px;">
                                            <h6 align="center"><a class="product-name" href="https://www.indianimporterschambers.com/">@lang("Indian Importers Chamber of Commerce and Industry(IICCI)")</a></h6>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="single_product" >
                                    ...
                                    <div class="hiraola-product_content">
                                        <div class="product-desc_info pt-1" style="padding-bottom: 20px;">
                                            <h6 align="center"><a class="product-name" href="https://bccci-bd.org/">@lang("Bangladesh China Chamber of Commerce and Industr(BCCCI)")</a></h6>
                                        </div>
                                    </div>
                                </div>
                            </div>
